  ...
  return (
    <div className="app-layout">
      ...
      <nav className="bottom-nav">
        {(() => {
          const navItems = ['overview', 'forms', 'submissions', 'payments', 'settings'];
          const activeIndex = Math.max(0, navItems.indexOf(activeTab));
          return (
            <div className={`nav-indicator ${activeIndex === 0 ? 'is-first' : ''} ${activeIndex === 4 ? 'is-last' : ''}`} style={{ transform: `translateX(${activeIndex * 100}%)` }}>
